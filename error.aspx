<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="error.aspx.cs" Inherits="template_test.error" %>
                    ...
                    <div class="col_cont">                    	                     	
                        <div class="wrap_cont">                        	
                            <header class="head_section">                            	                         	
                            	<h2>Sorry for the inconvenience,<br />we're on it please cooperate.<br />It's you who make us feel proud.</h2>
                                <Deterges>If you didn't get your order confirmation then don't worry just Whatsapp us (Name:Address:Total quantity & Date for Pickup)<br /> on +9124127762</Deterges>
