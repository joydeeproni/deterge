<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sign_up.aspx.cs" Inherits="template_test.sign_up" %>
                ...
                <div class="about_block bg_gray mb30">                	              	
                    <div class="col_cont">                    	                     	
                        <div class="wrap_cont">                        	
                            ...
                            <asp:Panel ID="Panel1" runat="server" Height="562px" Width="399px" style="text-align: center" >
                                <br />
                                <asp:Label ID="Labelname2" runat="server" Font-Names="Arial Black" Text="Enter your number:"></asp:Label>
                                <br />
                                <asp:TextBox ID="TextBoxphn_no" runat="server" style="text-align: center" TextMode="Phone"></asp:TextBox>
                                <br />
&nbsp;<br />&nbsp;<asp:Label ID="Labelname" runat="server" Font-Names="Arial Black" Text="Enter your name:"></asp:Label>
                                <br />
                                ...
                                <br />
                                 <br />
                                 <asp:Button ID="proceed" class="shortcode_button" runat="server" Text="PROCEED" OnClick="proceed_Click" />                            
                                <br />
                                <asp:Label ID="Labelveri_msg" runat="server" Font-Names="Arial Black" Text="Enter the VERIFICATION CODE you received as the missed call(exclude '+' sign) Example-123456****" Visible="False"></asp:Label>
                                <br />
                                ...
                                <br />
                                <asp:Label ID="Labelpwd" runat="server" Font-Names="Arial Black" Text="Create a password:" Visible="False"></asp:Label>
                                <asp:TextBox ID="TextBoxpwd" runat="server" Visible="False" TextMode="Password"></asp:TextBox>
                                <br />
                                <asp:Label ID="Labelcnf_pwd" runat="server" Font-Names="Arial Black" Text="Confirm password:" Visible="False"></asp:Label>
                                &nbsp;
                                <asp:TextBox ID="TextBoxcpwd" runat="server" Visible="False" TextMode="Password"></asp:TextBox>
                                <br />
                                ...
                                <br />
                                <asp:Button ID="signup" runat="server" class="shortcode_button" OnClick="signup_Click" Text="SIGN UP" Visible="False" />
                                <br />
